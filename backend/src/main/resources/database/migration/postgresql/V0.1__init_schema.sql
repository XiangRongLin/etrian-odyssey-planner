...
CREATE TABLE skill_info_prerequisites (
    ...
    CONSTRAINT skill_info_prerequisites__skill_info_id__prerequisite_id_PK PRIMARY KEY (skill_info_id, prerequisite_id),
...
CREATE TABLE skills (
    ...
    CONSTRAINT skills__skill_info_id__character_id_PK PRIMARY KEY (skill_info_id, character_id),
...
CREATE TABLE party_members (
    ...
    CONSTRAINT party_members__party_id__member_id_PK PRIMARY KEY (party_id, member_id),
