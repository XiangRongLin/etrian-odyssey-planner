...
interface CharacterService {
    suspend fun create(character: NewCharacter, jwtId: String): Int
    ...
    suspend fun update(characterSummary: CharacterSummary, jwtId: String)

    suspend fun delete(id: Int, jwtId: String): Boolean
}